...
<form class="ui form attached fluid loading segment" onsubmit="return contact(this)">
 ...
 <div class="field">
    <select required id="destination">
      ...
      <option>ABU to ZARIA-CITY</option>
      <option>ABU to ZANGO</option>
	   <option>ABU to EMANTO</option>
	    <option>ABU to RANDAR-KANO</option>
    </select>
  </div>   
  </div>
<div class="field">  
...
<div class="ui attached message">
  <div class="header">Validate Payment Information</div>
    <div class="header">Order Ref: <span style="color:red;font-size:15px"><?php echo $_SESSION['ORDERREF']?> <a href='index.php'>Cancel Order</a></span> </div> 
      <p>Please Note After Payment is Done Copy The Transaction-ID from the Reciept and Paste in the field below *</p>
...
<label>Payment</label>  
    <select name="gender" required id="paymentmethod">
      ...
      <option value="MPESA">GT-BANK:0180828871</option>
      <option value="KCD_BANK">ZENITH-BANK:2289881009</option>
	  <option value="EQUITY_BANK">ECO-BANK:9928001203</option>
    </select>
  </div> 
<div class="field"> 
...
<div class="ui icon input">
  <input value="N100.00" type="text" id="amount" readonly>
</div></div>
 <div style="text-align:center">
